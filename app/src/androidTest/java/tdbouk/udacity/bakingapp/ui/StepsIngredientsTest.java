...
/**
 * This test checks whether the ingredients fab opens
 * the bottom sheet containing a textview
 */

@RunWith(AndroidJUnit4.class)
public class StepsIngredientsTest {
    ...
    @Test
    public void clickOnIngredientsFab_CheckBottomSheet() {
        ...
        onView(withId(R.id.fab_show_ingredients)).perform(click());

        // Check if the textview within the bottomsheet is displayed
